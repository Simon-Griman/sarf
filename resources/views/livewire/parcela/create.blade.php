        ...
        <div class="border-b border-gray-400 dark:border-white/10 pb-12">
            ...
            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                ...
                <div class="sm:col-span-3">
                    <label for="producto_id" class="block text-sm/6 font-medium text-gray-800 dark:text-white">Producto
                        @if($validaciones['volumen'] ?? false)
                ...
                <div class="sm:col-span-3" x-data="{ open: false }">
                    <label class="block text-sm/6 font-medium text-gray-800 dark:text-white">Terminales de Destino
                        @if($validaciones['terminal_destino'] ?? false)
                        <span class="text-red-500">*</span></label>
                        @endif
                    </label>
                ...
                <div class="sm:col-span-3">
                    <label for="volumen" class="block text-sm/6 font-medium text-gray-800 dark:text-white">Volumen
                        @if($validaciones['volumen'] ?? false)
                        <span class="text-red-500">*</span></label>
                        @endif
                    <div class="mt-2">
