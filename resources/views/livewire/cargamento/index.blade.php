    ...
    <x-table>
        <x-slot name="thead">
            ...
            <tr>
                ...
                <th class="pt-2">
                    @can('resumen.create')
                    <x-success-button wire:click="modalCargamento"><i class="fas fa-user-plus pr-2"></i>Crear</x-success-button>
                    @endcan
                </th>
            </tr>
                    ...
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4 dark:bg-gray-800">
                        <div class="sm:flex sm:items-center w-full text-center">
                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 w-full">
                                <h2 class="text-xl font-semibold text-gray-900 dark:text-white pb-4" id="modal-title">Crear Cargamento</h2>
                                <div class="mt-2">
                                    <button type="button" wire:click="crearCargamento('carga')" wire:loading.attr="disabled"  class="inline-flex w-full justify-center rounded-md bg-red-600 px-3 py-2 text-sm font-semibold text-white hover:bg-red-500  sm:w-auto">
                                        <span wire:loading.remove> <i class="fa-solid fa-up-long"></i> Carga</span>
                                        <span wire:loading>Entrando...</span>
                                    </button>

                                    <button type="button" wire:click="crearCargamento('descarga')" wire:loading.attr="disabled"  class="inline-flex w-full justify-center rounded-md bg-blue-600 px-3 py-2 text-sm font-semibold text-white hover:bg-red-500 sm:ml-3 sm:w-auto">
                                        <span wire:loading.remove><i class="fa-solid fa-down-long"></i> Descarga</span>
                                        <span wire:loading>Entrando...</span>
                                    </button>

                                    <button type="button" wire:click="crearCargamento('importacion')" wire:loading.attr="disabled"  class="inline-flex w-full justify-center rounded-md bg-amber-600 px-3 py-2 text-sm font-semibold text-white hover:bg-red-500 sm:ml-3 sm:w-auto">
                                        <span wire:loading.remove><i class="fa-solid fa-file-import"></i> Importación</span>
                                        <span wire:loading>Entrando...</span>
                                    </button>

                                    <button type="button" wire:click="crearCargamento('exportacion')" wire:loading.attr="disabled"  class="inline-flex w-full justify-center rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white hover:bg-red-500 sm:ml-3 sm:w-auto">
