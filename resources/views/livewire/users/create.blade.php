                ...
                <div class="sm:col-span-3" x-data="{ open: false }">
                    ...
                    <div class="relative mt-2 @click.away="open = false">
                        <button 
                            @click="open = !open" 
                            type="button" 
                            class="w-full flex items-center justify-between bg-zinc-800 border border-zinc-500 rounded-md px-4 py-1.5 text-left text-gray-300 hover:border-zinc-500 focus:outline-none focus:ring-2 focus:ring-blue-600 transition-all"
                        >
                            <span class="truncate">
