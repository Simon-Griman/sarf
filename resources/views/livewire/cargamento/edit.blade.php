    ...
    <div class="space-y-12 sm:px-6" style="height: 79vh">
        <div class="border-b border-gray-400 dark:border-white/10 pb-12">
            ...
            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                ...
                <div class="sm:col-span-2">
                    <label for="terminales_destinos_ids" class="block text-sm/6 font-medium text-gray-800 dark:text-white">Terminal de Destino<span class="text-red-500">*</span></label>
                    <div class="mt-2 grid grid-cols-1">
                        <x-form-select id="terminales_destinos_ids" name="terminales_destinos_ids" autocomplete="terminales_destinos_ids" wire:model.blur="terminales_destinos_ids" @blur="$wire.$refresh()">
                            <option value="">-- Seleccionar --</option>
